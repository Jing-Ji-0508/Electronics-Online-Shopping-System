...
public class AdminUser extends User {
	...
	public void adminLogin() {
		System.out.println("Welcome! Administrator:" + this.getUserName());
	}
	...
	public void addGoods(Long goodsId, String goodsName, String goodsIntro, double originalPrice,
			double sellPrice, int stockNum, String goodsSellStatus, Long categoryId, String categoryName) {
		MallGoods newGoods = new MallGoods(goodsId, goodsName, goodsIntro, originalPrice, sellPrice, stockNum, goodsSellStatus, categoryId, categoryName);
		System.out.println(newGoods.getGoodsName() + " has been added successfully.");
	}
	
	public void updateGoods(MallGoods mallGoods, Long goodsId, String goodsName, String goodsIntro, double originalPrice,
			double sellPrice, int stockNum, String goodsSellStatus, Long categoryId, String categoryName) {
